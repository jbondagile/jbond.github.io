...
rpg_tutorial.start = function(){          
    ...
    //hero definition
    var hero = new lime.Sprite().setSize(40,36).setFill('monster.png').setPosition(100,100); 
    hero.life = 20; 
    hero.money = 100; 
    hero.attack = 5;
    //monster definition
    var monster = new lime.Sprite().setSize(40,36).setFill('monster2.png').setPosition(200,200);
    monster.life = 15;
    monster.money = 10;
    monster.attack = 1;
